...
pub fn day22_1() {
  let input = read_input("./day22/input").into_iter().map(|x| {
    let (op, x1, x2, y1, y2, z1, z2) = scan_fmt!(&x, "{} x={}..{},y={}..{},z={}..{}", String, i32, i32, i32, i32, i32, i32).unwrap();
...
impl Cube {
  fn size(&self) -> i64 {
    (self.xmax - self.xmin) as i64 * (self.ymax - self.ymin) as i64 * (self.zmax - self.zmin) as i64
  }
