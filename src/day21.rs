...
fn get_wins_from_position(universes: &mut Universes, rolls: &[usize], pos_1: usize, score_1: usize, pos_2: usize, score_2: usize, is_player_1_moving: bool) -> (usize, usize) {
  ...
  for i in 3..10 {
    ...
    scores = get_wins_from_position(universes, rolls, pos_2, score_2, new_position, new_score, !is_player_1_moving);
...
pub fn day21() {
  ...
  let (wins_1, wins_2) = get_wins_from_position(&mut universes, &possible_roles, start_1, 0, start_2, 0, true);
